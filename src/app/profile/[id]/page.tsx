						...
						<div className='space-y-1'>
							...
							<div className='flex items-center gap-2 text-sm text-white ml-8'>
								<div className='flex items-center gap-1'>
									...
									<span className='font-semibold'>{compactNumber(videoCount)}</span>
								</div>
								...
								<div className='flex items-center gap-1'>
									...
									<span className='font-semibold'>{compactNumber(likesCount)}</span>
								</div>
								<span className='text-white/60'>•</span>
								<div className='flex items-center gap-1'>
									<svg className='w-4 h-4' fill='currentColor' viewBox='0 0 24 24'>
									...
									<span className='font-semibold'>{compactNumber(displayFollowersCount)}</span>
								</div>
							</div>
						</div>
					</div>
